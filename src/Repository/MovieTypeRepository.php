 ...
 */
class MovieTypeRepository extends ServiceEntityRepository
{
    ...
    public function save(MovieType $entity, bool $flush = false): void
    {
    ...
    public function remove(MovieType $entity, bool $flush = false): void
    {
